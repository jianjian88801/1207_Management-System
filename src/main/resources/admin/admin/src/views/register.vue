  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:20px">
        <h1 class="h1" style="color:#000;fontSize:26px;">大创管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="账号" class="input" v-if="tableName=='zhidaolaoshi'">
			  <el-input v-model="ruleForm.zhanghao" autocomplete="off" placeholder="账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhidaolaoshi'" class="input-group">
			   <div class="label">密码</div>
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='zhidaolaoshi'">
			  <el-input v-model="ruleForm.xingming" autocomplete="off" placeholder="姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhidaolaoshi'" class="input-group">
			   <div class="label">手机</div>
			...
			<!-- <div v-if="tableName=='yuanxiguanliyuan'" class="input-group">
			   <div class="label">账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhanghao" class="input" type="text" placeholder="账号">
			   </div>
			 </div> -->
			<el-form-item label="账号" class="input" v-if="tableName=='yuanxiguanliyuan'">
			  <el-input v-model="ruleForm.zhanghao" autocomplete="off" placeholder="账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yuanxiguanliyuan'" class="input-group">
			   <div class="label">密码</div>
			...
			<el-form-item label="密码" class="input" v-if="tableName=='yuanxiguanliyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='yuanxiguanliyuan'" class="input-group">
			   <div class="label">姓名</div>
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='yuanxiguanliyuan'">
			  <el-input v-model="ruleForm.xingming" autocomplete="off" placeholder="姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yuanxiguanliyuan'" class="input-group">
			   <div class="label">手机</div>
			...
			<el-form-item label="手机" class="input" v-if="tableName=='yuanxiguanliyuan'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yuanxiguanliyuan'" class="input-group">
			   <div class="label">邮箱</div>
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='yuanxiguanliyuan'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.zhanghao) && `zhidaolaoshi` == this.tableName){
        this.$message.error(`账号不能为空`);
        return
      }
      ...
      if((!this.ruleForm.zhanghao) && `yuanxiguanliyuan` == this.tableName){
        this.$message.error(`账号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `yuanxiguanliyuan` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if(`yuanxiguanliyuan` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
      if(`yuanxiguanliyuan` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮件格式`);
        return
      }
      this.$http({
