<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="涉及领域" prop="shejilingyu">
          <el-input v-model="ruleForm.shejilingyu" 
              placeholder="涉及领域" clearable  :readonly="ro.shejilingyu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="涉及领域" prop="shejilingyu">
              <el-input v-model="ruleForm.shejilingyu" 
                placeholder="涉及领域" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  data() {
	...
	shhf : false,
      ...
      rules: {
          ...
          xueshengtuandui: [
                { required: true, message: '学生团队不能为空', trigger: 'blur' },
          ],
          chengyuanjieshao: [
          ],
          zhidaolaoshi: [
