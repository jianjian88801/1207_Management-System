    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="理论依据" prop="lilunyiju">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="理论依据"
                  v-model="ruleForm.lilunyiju" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.lilunyiju" label="理论依据" prop="lilunyiju">
                    <span>{{ruleForm.lilunyiju}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="主要成果" prop="zhuyaochengguo">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="主要成果"
                  v-model="ruleForm.zhuyaochengguo" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuyaochengguo" label="主要成果" prop="zhuyaochengguo">
                    <span>{{ruleForm.zhuyaochengguo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="终结成果" prop="zhongjiechengguo">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="终结成果"
                  v-model="ruleForm.zhongjiechengguo" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhongjiechengguo" label="终结成果" prop="zhongjiechengguo">
                    <span>{{ruleForm.zhongjiechengguo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	lilunyiju : false,
	zhuyaochengguo : false,
	zhongjiechengguo : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiangmujianjie = true;
          ...
          if(o=='lilunyiju'){
            this.ruleForm.lilunyiju = obj[o];
	    this.ro.lilunyiju = true;
            continue;
          }
          if(o=='zhuyaochengguo'){
            this.ruleForm.zhuyaochengguo = obj[o];
	    this.ro.zhuyaochengguo = true;
            continue;
          }
          if(o=='zhongjiechengguo'){
            this.ruleForm.zhongjiechengguo = obj[o];
	    this.ro.zhongjiechengguo = true;
            continue;
          }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xiangmujiexiang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiangmujiexiangCrossAddOrUpdateFlag = false;
                  this.parent.search();
