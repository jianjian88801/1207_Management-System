...
public class YouxiuxiangmuController {
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YouxiuxiangmuEntity youxiuxiangmu, HttpServletRequest request){
        EntityWrapper<YouxiuxiangmuEntity> ew = new EntityWrapper<YouxiuxiangmuEntity>();
		PageUtils page = youxiuxiangmuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, youxiuxiangmu), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<YouxiuxiangmuEntity> wrapper = new EntityWrapper<YouxiuxiangmuEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = youxiuxiangmuService.selectCount(wrapper);
